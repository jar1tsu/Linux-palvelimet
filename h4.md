...
Aloitin tehtävän Lataamalla palvelin userille Apache2:sen. Ja loin sinne yksinkertaisen sivun echo "<h1>Terve JARIN VPS</h1>" | sudo tee /var/www/html/index.html komennolla. Avasin palvelimen ja kokeilin tietokoneella ja puhelimella ja se toimi!
